...
import { decrement, increment, incrementByAmount, incrementAsync, selectCount, setArray } from '@/models/counter';
  ...
  return (
    <div>
      ...
      <div className={styles.row}>
        ...
        <button className={styles.asyncButton} onClick={() => dispatch(setArray())}>
          Array
        </button>
      </div>
    </div>
